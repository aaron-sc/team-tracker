...
INSERT INTO "new_OnboardingTask" ("active", "body", "createdAt", "createdById", "description", "fileName", "fileUrl", "id", "order", "orgId", "required", "title", "type", "updatedAt", "url") SELECT "active", "body", "createdAt", "createdById", "description", "fileName", "fileUrl", "id", "order", "orgId", "required", "title", "type", "updatedAt", "url" FROM "OnboardingTask";
