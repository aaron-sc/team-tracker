...
export const PERMISSION_GROUPS: { label: string; permissions: Permission[] }[] = [
  {
    ...
    permissions: [
      ...
      Permission.org_members_contact_view,
      Permission.org_data_reset,
...
export const PERMISSION_LABELS: Record<Permission, string> = {
  ...
  org_members_contact_view: "View member email addresses",
  org_data_reset: "Reset organization data (roster, schedule, recruitment, messages, announcements)",
