...
export function SessionResultForm({
  ...
  defaultValues: { resultStatus?: string | null; scoreFor?: number | null; scoreAgainst?: number | null };
}) {
    ...
    <form action={formAction} className="flex flex-wrap items-end gap-3">
      ...
      <div className="space-y-1.5">
        ...
        <Input
          ...
          min={0}
          className="w-20"
          defaultValue={defaultValues.scoreFor ?? undefined}
        />
      </div>
      <div className="space-y-1.5">
        ...
        <Input
          ...
          min={0}
          className="w-20"
          defaultValue={defaultValues.scoreAgainst ?? undefined}
        />
      </div>
