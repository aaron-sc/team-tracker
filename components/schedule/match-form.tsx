    ...
    <form action={formAction} className="max-w-xl space-y-4">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="space-y-1.5">
          ...
          <Select name="format" defaultValue={defaultValues?.format ?? "BO1"}>
      ...
      <div className="flex items-center gap-2">
        <Checkbox
          ...
          name="isStreamed"
          checked={isStreamed}
          onCheckedChange={(v) => setIsStreamed(!!v)}
        />
        <Label htmlFor="isStreamed" className="cursor-pointer font-normal">
      ...
      {isStreamed ? (
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="space-y-1.5">
            ...
            <Input id="streamPlatform" name="streamPlatform" placeholder="Twitch" defaultValue={defaultValues?.streamPlatform} />
          </div>
          <div className="space-y-1.5">
            <Label htmlFor="streamUrl">Stream URL</Label>
            <Input id="streamUrl" name="streamUrl" type="url" placeholder="https://twitch.tv/…" defaultValue={defaultValues?.streamUrl} />
          </div>
          <div className="space-y-1.5">
            <Label htmlFor="casterName">Caster</Label>
            <Input id="casterName" name="casterName" defaultValue={defaultValues?.casterName} />
          </div>
        </div>
      ) : null}

      <div className="space-y-1.5">
        <Label htmlFor="notes">Notes / scouting</Label>
